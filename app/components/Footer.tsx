...
import img from '@/public/gabriel-meinert-CcUlWQVptMs-unsplash.jpg'
import React from 'react'

const Footer = () => {
  return (
    <footer className="text-white/90 lg:grid lg:grid-cols-5">
    ...
    <div className="mt-12 border-t border-gray-100 pt-12">
      <div className="sm:flex sm:items-center sm:justify-between">
        ...
        <p className="mt-8 text-xs  sm:mt-0">
          &copy; 2024. Cofee shop. All rights reserved.
        </p>
      </div>
    </div>
  </div>
